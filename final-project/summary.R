...
hpi$Inequality.of.Outcomes <- as.numeric(hpi$Inequality.of.Outcomes)
average_inequality <-(mean(hpi$Inequality.of.Outcomes))
...
region_hpi<- hpi %>% 
  select(Region, Average.Life..Expectancy, Average.Wellbeing..0.10., 
         Inequality.of.Outcomes, Footprint..gha.capita., Population, 
  ...
  summarise(Average.Life.Expectancy= round(mean(Average.Life..Expectancy),digits=2),
            ...
            Inequality.of.Outcomes = round(mean(Inequality.of.Outcomes)*100, digits=2))
